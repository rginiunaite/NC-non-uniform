//
// Created by giniunaite on 21/07/20.
...
// Not sure whether I understand the comments above but I will try ablation, front-to-back and back-to-front experiments
//
...
// parameters for the dynamics of chemoattractant concentration
    ...
    double speed_l = 0.16;// 0.05;//1;//0.05; // speed of a leader cell, 42 (corresponds to 0.14) and 48 um/h corresponds to 0.16 (since 0.16*5 *60 = 48)
...
//
        ...
        //if (counter % 10 == 0) { // 50 did not work
...
//
                #ifdef HAVE_VTK
                vtkWriteGrid("50cellsonlyCELLS", t, particles.get_grid(true));
                #endif

//
//
//                //ofstream output("matrix_FIRST_025theta" + to_string(int(round(t))) + ".csv");
                ofstream output("50cellsonlyMATRIX" + to_string(int(t)) + ".csv");
...
// */
    ...
    cout << "numbr of cells" << particles.size() << endl;

...
errordx1 = 'errordx1.txt';
dx1 = csvread(errordx1);

errordx01 = 'errordx01.txt';
dx01 = csvread(errordx01);

errordx001 = 'errordx001.txt';
dx001 = csvread(errordx001);

errordx0001 = 'errordx0001.txt';
...
figure
plot (time,dx1,time,dx01,time,dx001,time, dx0001,'Linewidth',3)
%ylim([0,1.5])
%xlim([0,200])
...
legend('\Delta x = 1.000','\Delta x = 0.100' ,'\Delta x = 0.010','\Delta x = 0.001')
set(gca,'FontSize',36)
ax = gca;

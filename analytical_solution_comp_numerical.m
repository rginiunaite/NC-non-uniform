...
plot (real_grid(:,1), sol(:,1),'LineWidth',4); % corresponds to time 0
hold on
plot (real_grid(:,11),sol(:,11),'LineWidth',4); %% corresponds to time 10

plot(real_grid(:,21),sol(:,21),'LineWidth',4);
xlim([0,800])
...
plot(distance1,concentration1,':', 'Linewidth',4,'HandleVisibility','off')

hold on

%plot(distance2,concentration2, 'Linewidth',3)

plot(distance3,concentration3,':', 'Linewidth',4,'HandleVisibility','off')

plot(distance4,concentration4,':', 'Linewidth',4,'HandleVisibility','off')
...
L2t1 = norm(difference_time1)
L2t10 = norm(difference_time10)
L2_t20 = norm(difference_time20)
